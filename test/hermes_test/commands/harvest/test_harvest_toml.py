...
@pytest.mark.parametrize("in_data", [(15), ([{}, (15)]), (None)])
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            {"project": {"name": "a", "requires-python": ">3.7"}},
            {"name": "a", "runtimePlatform": "Python >3.7"},
        ),
        (
            {"project": {"authors": {"givenName": "a"}}},
            {"author": {"givenName": "a", "@type": "Person"}},
        ),
        (
            {"project": {"authors": [{"givenName": "a"}, {"givenName": "a"}]}},
            {
                "author": [
                    {"givenName": "a", "@type": "Person"},
                    {"givenName": "a", "@type": "Person"},
                ]
            },
        ),
        (
            {"project": {"authors": {"givenName": "a", "a": "b"}}},
            {"author": {"givenName": "a", "@type": "Person"}},
        ),
        ({"project": {"authors": {"a": "b"}}}, {}),
        (
            {"project": {"authors": [{"a": "a"}, {"givenName": "a"}]}},
            {"author": {"givenName": "a", "@type": "Person"}},
        ),
        ({"project": {"authors": [{"a": "b"}]}}, {}),
        (
            {"project": {"authors": ["abc def<abc.def@dlr.com>"]}},
            {
                "author": {
                    "name": "abc def",
                    "email": "abc.def@dlr.com",
                    "@type": "Person",
                }
            },
        ),
