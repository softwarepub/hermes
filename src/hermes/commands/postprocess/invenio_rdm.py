    ...
    def __call__(self, command: HermesCommand):
        ...
        try:
            ...
            new_identifier = {
                ...
                "[generated by hermes]",
                'type': 'doi',
                'value': deposition['metadata']['prereserve_doi']['doi']
            }
    ...
    def __call__(self, command: HermesCommand):
        ...
        try:
            ...
            if "referencePublication" not in codemeta:
                codemeta["referencePublication"] = doi
            elif isinstance(codemeta["referencePublication"], list):
                codemeta["referencePublication"].append(doi)
            else:
                codemeta["referencePublication"] = [codemeta["referencePublication"], doi]
